...
yesBtn.addEventListener('click', function(){
    alert('Siempre supe que aceptarias Te quiero Jasmin Zamora'); //Puedes mandar los mensajes que quieras
    location.href = 'https://www.youtube.com/watch?v=QQ0u1s1CClM'; //Cambiar el URL en YouTube de la canción que quieras 
});
